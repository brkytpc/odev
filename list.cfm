        ...
        <table class="table table-bordered" id="myTable" >
            ...
            <tbody id="myTables">
              <tr>
                ...
                <td><cfoutput>#gonderiTipiFonk()#</cfoutput></td>

                <td><cfoutput>#durumFonk()#</cfoutput></td>
                

                <td><cfoutput>#listData.ACIKLAMA#</cfoutput></td>
                <td><cfoutput>#listData.TESLIM_TARIHI#</cfoutput></td>                
                <td><a href="update.cfm?id=<cfoutput>#listData.ID#</cfoutput>"><i class="fas fa-pencil-alt"></i></td>
                <td><a href="delete.cfm?id=<cfoutput>#listData.ID#</cfoutput>"><i class="fas fa-eraser"></i></a></td>
